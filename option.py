...
def get_args_parser():
    ...
    parser.add_argument('--exp-name',type=str, default='RIMES_HTR_ORIGAMI_NET', help='experimental name (save dir will be out_dir + exp_name)')
    ...
    RIMES = subparsers.add_parser("RIMES",
                                description='Dataset parser for training on RIMES',
                                add_help=True,
                                formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                help="Dataset parser for training on RIMES")

    RIMES.add_argument('--train-data-list', type=str, default='./data/RIMES/Sets/TrainLines.txt',
                     help='train data list (gc file)(ln file)')
    RIMES.add_argument('--image-path', type=str, default='./data/RIMES/Images/',
                     help='path to images')
    RIMES.add_argument('--text-path', type=str, default='./data/RIMES/Transcriptions/',
                     help='path to text')
    RIMES.add_argument('--val-data-list', type=str, default='./data/RIMES/Sets/ValidationLines.txt',
                     help='val data list')
    RIMES.add_argument('--test-data-list', type=str, default='./data/RIMES/Sets/TestLines.txt',
                     help='test data list')
    RIMES.add_argument('--nb-cls', default=80, type=int, help='nb of classes, IAM=79+1, READ2016=89+1')
