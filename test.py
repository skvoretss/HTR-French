...
def main():
    ...
    train_dataset = dataset.myLoadDS(args.train_data_list, args.image_path, args.text_path, args.img_size)

    test_dataset = dataset.myLoadDS(args.test_data_list, args.image_path, args.text_path, args.img_size, ralph=train_dataset.ralph)
